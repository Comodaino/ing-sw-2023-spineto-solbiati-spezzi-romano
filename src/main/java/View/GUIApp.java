...
public class GUIApp extends Application implements ViewInterface {
     ...
     * p
     *
     * @param primaryStage app's primary stage
    ...
    private void play(AbstractClient client, Stage primaryStage) throws RemoteException {
    ...
    private GridPane getCommonGoal(AbstractClient client) {
    ...
    private VBox createShelf(AbstractClient client, GridPane mainPane) throws RemoteException {
        ...
        if (client.getBoardView().getCurrentPlayer().getNickname().equals(client.getNickname())) {
            ...
            for (int i = 0; i < client.getBoardView().getTileBuffer().size(); i++) {
                String pathSwitch = createTile(i);
                SwitchButton switchButton = new SwitchButton(this, i, command, pathSwitch);
                switchButton.setGraphic(pathSwitch);
                ...
                cancel.addListener(new ChangeListener<Boolean>() {
                    ...
                    public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                        ...
                        switchButton.setGraphic(switchButton.getGraphic());
    ...
    private VBox showOtherShelf(AbstractClient client) throws RemoteException {
        ...
        shelfPlayer3.setPrefSize(200, 200);
    ...
    private void home(Stage stage, String nickname) {
    ...
    /**Updates the current view, checking for state and changes
     *
     * @param arg adds more check options in regard of the argument passed, arg can be:
     *            disconnected
     *            nickname
     * @throws IOException
     *
